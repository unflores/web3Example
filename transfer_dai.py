...
w3 = Web3(HTTPProvider("https://ropsten.infura.io/v3/__NODE__",request_kwargs={'timeout':60}))
w3.eth.setGasPriceStrategy(medium_gas_price_strategy)

dai_contract_address = Web3.toChecksumAddress("0xad6d458402f60fd3bd25163575031acdce07538d")

contract_instance = w3.eth.contract(address=dai_contract_address, abi=contract_abi)

print(contract_instance.functions.name().call())

private_key = w3.sha3(text = "PoopooCaca")
...
transaction = contract_instance.functions.transfer(metamask_address, 10*10**18).buildTransaction()
